...
#define LEDBUTTON_BUZZ_PIN              BSP_LED_3_MASK
#define LEDBUTTON_BUTTON_PIN            BSP_BUTTON_0                                /**< Button that will trigger the notification event with the LED Button Service */
#define LEDBUTTON_MODE_PIN              BSP_BUTTON_2                                /**< Button that will trigger the notification event with the LED Button Service */
...
{
    LEDS_CONFIGURE(ADVERTISING_LED_PIN | CONNECTED_LED_PIN | LEDBUTTON_LED_PIN | LEDBUTTON_BUZZ_PIN);
    LEDS_OFF(ADVERTISING_LED_PIN | CONNECTED_LED_PIN | LEDBUTTON_LED_PIN | LEDBUTTON_BUZZ_PIN);
}
...
static void battery_level_update(void)
{
    ...
    uint8_t  battery_level;
	  ...
	  val = saadc_val * 720 /1024 -300;
	  if(val>= 0x63) battery_level=99;
...
static void led_write_handler(ble_lbs_t * p_lbs, uint8_t led_state)
{
    if (led_state)
    {
		...
		LEDS_OFF(LEDBUTTON_BUZZ_PIN);
    }
    else
    {
        LEDS_OFF(LEDBUTTON_LED_PIN);
		LEDS_ON(LEDBUTTON_BUZZ_PIN);
    }
}
